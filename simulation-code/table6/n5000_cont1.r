...
sourceCpp("/home/zeldow/paper1/code/semibart/src/smmbart_arma.cpp")
source("/home/zeldow/paper1/code/semibart/R/semibart.R")
...
save(smm.res, smm.in.ci, file = "./output/n5000_cont1.Rdata")
